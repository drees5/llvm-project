#ifndef NEEDMAN_WUNSCH_DEPRECATED_H
#define NEEDMAN_WUNSCH_DEPRECATED_H
...
class NeedlemanWunchSA__deprecated
...
public:
  ...
  NeedlemanWunchSA__deprecated()
      : BaseType(getDefaultScoring(), nullptr), Matrix(nullptr),
        Matches(nullptr) {}

  NeedlemanWunchSA__deprecated(ScoringSystem Scoring, MatchFnTy Match = nullptr)
      : BaseType(Scoring, Match), Matrix(nullptr), Matches(nullptr) {}

  ~NeedlemanWunchSA__deprecated() { clearAll(); }
